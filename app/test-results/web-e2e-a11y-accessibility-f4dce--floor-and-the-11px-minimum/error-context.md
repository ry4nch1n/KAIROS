...
- Name: web\e2e\a11y.spec.ts >> accessibility — WCAG 2.1 AA >> revenue: text meets the contrast floor and the 11px minimum
...
Call log:
  - navigating to "/#revenue", waiting until "load"
