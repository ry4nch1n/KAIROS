...
- Name: web\e2e\a11y.spec.ts >> accessibility — WCAG 2.1 AA >> radar-comparables: text meets the contrast floor and the 11px minimum
- Location: web\e2e\a11y.spec.ts:83:5
...
Call log:
  - navigating to "/#radar/comparables", waiting until "load"
