...
- Name: web\e2e\a11y.spec.ts >> accessibility — WCAG 2.1 AA >> radar-comparables: has exactly one h1 and skips no heading level
- Location: web\e2e\a11y.spec.ts:136:5
