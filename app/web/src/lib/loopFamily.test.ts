...
const p = (over: Partial<Pitch>): Pitch => ({
  id: over.id ?? 1,
  slug: over.slug ?? "s", title: over.title ?? "T", loopFamily: over.loopFamily ?? null,
  status: over.status ?? "proposed", rank: null, oneLiner: null, platformLadder: null,
  badge: null, loopDetail: null, browserMvp: null, steamLadder: null, evidence: null,
  risk: null, browserFit: null, steamFit: null, buildEase: null, provenance: null,
  grayBoxDays: null, contentScope: null, techRisk: null, hook: null, marketability: null,
  founderFit: null, whyMe: null, pitchDate: "2026-07-13", batch: null, source: null,
  setting: null, artStyle: null, codeName: null, headerUrl: null, shotUrl: null,
} as Pitch);
